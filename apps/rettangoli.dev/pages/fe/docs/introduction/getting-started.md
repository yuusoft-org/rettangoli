...
- [Component Architecture](../guides/component-architecture) — understand the 4-file pattern and data flow
- [View](../guides/view) — template syntax, bindings, and control flow
- [Store](../guides/store) — state management and actions
- [Handlers](../guides/handlers) — lifecycle hooks and event handling
